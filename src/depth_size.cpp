...
//Usage: rosrun slam_dataset_rospkg depth_size_subscriber _image_topic:=<TOPIC NAME>
...
int main(int argc, char** argv)
{
    ...
    ros::init(argc, argv, "depth_size_subscriber");

    // Create a ROS node handle
    ros::NodeHandle nh("~");

    // Default image topic (in case a parameter is not provided)
    std::string image_topic = "/camera/depth/image_raw";
